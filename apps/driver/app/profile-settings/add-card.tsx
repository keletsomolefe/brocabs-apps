...
export default function AddCardScreen() {
  ...
  const handleNext = async () => {
    if (selectedMethod === "manual") {
      router.push("/profile-settings/card-details");
  ...
  return (
    <>
      ...
      <Fill backgroundColor="Bg Color">
        {/* Content */}
        <Container flex={1} px={20} pt={40} pb={40} gap={30} justifyContent="center">
          {/* Title */}
          ...
          <Container gap={20}>
            ...
            <TouchableOpacity onPress={() => setSelectedMethod("scan")}>
              <Container
                ...
                <Medium fontSize={16} lineHeight={16} color="Primary/50">
                  Scan card
                </Medium>
