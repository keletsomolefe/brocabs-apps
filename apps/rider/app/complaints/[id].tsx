  ...
  return (
    <Container
      ...
      <Regular fontSize={14} color={color}>
        {status === "Pending" ? t("common.pending") : t("common.resolved")}
      </Regular>
    </Container>
  );
}
      ...
      <ScrollView
        ...
        <Container px={20} pt={20} gap={16}>
          ...
          <Container backgroundColor="white" borderRadius={20} px={20} py={16} style={shadow}>
            <InfoRow label={t("common.status")} value={<StatusTag status={complaint.status} />} />
            <Container height={1} backgroundColor="Neutrals/100" my={1} />
            <InfoRow label={t("common.date")} value={complaint.date} />
            <Container height={1} backgroundColor="Neutrals/100" my={1} />
            <InfoRow label={t("common.time")} value={complaint.time} />
          </Container>

          {/* Details Card */}
          <Container backgroundColor="white" borderRadius={20} px={20} py={16} style={shadow}>
            <InfoRow label={t("common.subject")} value={complaint.subject} />
            <Container height={1} backgroundColor="Neutrals/100" my={1} />
            <InfoRow label={t("common.tripID")} value={complaint.tripId} />
            <Container height={1} backgroundColor="Neutrals/100" my={1} />
          ...
          <Container backgroundColor="white" borderRadius={20} px={20} py={16} style={shadow}>
            <InfoRow label={t("common.desiredOutcome")} value={complaint.desiredOutcome} />
          </Container>
