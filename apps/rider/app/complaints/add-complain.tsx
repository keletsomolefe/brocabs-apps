...
export function AddComplaintScreen() {
  ...
  const DESIRED_OUTCOME_OPTIONS: Option[] = [
    ...
    { label: t("common.partialRefund"), value: "partial_refund" },
      ...
      <PagerView
        ...
        <Container key="describe">
          <DescribeStep
            ...
            outcomeOptions={DESIRED_OUTCOME_OPTIONS}
          />
        </Container>
      ...
      <Container px={20} pt={16} gap={16}>
        <Container gap={10}>
          ...
          <Container
            ...
            <TextInput
              ...
              placeholder={t("common.tripOrRider")}
        ...
        <Container gap={10}>
          ...
          <Row gap={10} flexWrap="wrap">
            {suggestedSubjects.map((suggested) => (
              <TouchableOpacity
                key={suggested}
              ...
              <TouchableOpacity
                ...
                <Container
                  ...
                  <Row alignItems="center" gap={12}>
                    ...
                    <Regular fontSize={14} color="Danger/600">
                      - {trip.price}
                    </Regular>
                  </Row>
                </Container>
  ...
  return (
    <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
      <Container px={20} pt={20} gap={16}>
        <Container gap={10}>
          ...
          <Container
            ...
            <TextInput
              ...
              placeholder={t("common.explainProblem")}
              placeholderTextColor={Colors["Neutrals/400"]}
              multiline
              numberOfLines={5}
              maxLength={500}
        ...
        <Container gap={10}>
          <Regular fontSize={16} color="Neutrals/400">
            {t("common.desiredOutcome")}
          </Regular>
          <DropdownField
            value={desiredOutcome}
            placeholder={t("common.selectOutcome")}
            data={outcomeOptions}
...
function ReviewStep({
  ...
  const desiredOutcomeLabel =
    outcomeOptions.find((opt) => opt.value === formData.desiredOutcome)?.label ||
    ...
    <ScrollView contentContainerStyle={{ paddingBottom: 100 }} showsVerticalScrollIndicator={false}>
      <Container px={20} pt={20} gap={16}>
        ...
        <Container backgroundColor="white" borderRadius={20} px={20} py={16} style={shadow}>
          <InfoRow label={t("common.subject")} value={formData.subject} />
          <Container height={1} backgroundColor="Neutrals/100" my={1} />
          <InfoRow label={t("common.tripID")} value={selectedTrip?.id || t("common.nA")} />
          <Container height={1} backgroundColor="Neutrals/100" my={1} />
        ...
        <Container backgroundColor="white" borderRadius={20} px={20} py={16} style={shadow}>
          <InfoRow label={t("common.desiredOutcome")} value={desiredOutcomeLabel} />
        </Container>
