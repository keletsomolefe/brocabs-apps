...
const GET_PROFILE_TYPE = NotificationsControllerGetNotificationsProfileTypeEnum.Rider;
const MARK_ALL_PROFILE_TYPE = NotificationsControllerMarkAllAsReadProfileTypeEnum.Rider;
