...
export const DeleteAddressSheet = forwardRef<BottomSheetModal, DeleteAddressSheetProps>(
  ({ onDelete, addressLabel }, ref) => {
          ...
          <Container alignItems="center" gap={20}>
            <Container alignItems="center" gap={20}>
              ...
              <Bold fontSize={22} color="Primary/50" textAlign="center">
                {t("common.deleteAddressTitle")}
              </Bold>
              <Regular fontSize={18} lineHeight={24} color="Primary/50" textAlign="center">
                {t("common.deleteAddressConfirm", { label: addressLabel ?? "" })}
              </Regular>
            </Container>
...
DeleteAddressSheet.displayName = "DeleteAddressSheet";
