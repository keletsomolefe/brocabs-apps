...
import { Container, Divider, Fill, Image, PressableScale, Row } from "@brocabs/ui/layout";
...
// Temporary asset mapping until rider app has consistent asset structure
const LocalAssets = {
                ...
                <Container>
                  <Row alignItems="center" justifyContent="space-between" py={12}>
                    <Row alignItems="center" gap={12}>
                      <Image
                        source={LocalAssets["placeholder-avatar"]}
                        width={48}
                        height={48}
                        borderRadius={24}
                      />
