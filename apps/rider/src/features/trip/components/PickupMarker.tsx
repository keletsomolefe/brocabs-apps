...
export const PickupMarker = ({ loading, avatar }: PickupMarkerProps) => {
  return (
    <View style={{ width: 41, height: 56, alignItems: "center", justifyContent: "flex-end" }}>
      {/* Shadow */}
      ...
      <View style={{ width: 41, height: 54, marginBottom: 2 }}>
        <Svg width={41} height={54} viewBox="0 0 41 54" style={{ position: "absolute" }}>
          {/* Pin Body */}
          <Path
        ...
        <View
          ...
          {loading ? (
            ...
            <Icon name="profile-fill" width={33} height={33} color={Colors["Primary/400"]} />
          )}
        </View>
      </View>
    </View>
