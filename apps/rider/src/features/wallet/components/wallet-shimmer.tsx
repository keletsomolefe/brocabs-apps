...
/**
 * Empty state shimmer - simpler version for empty wallet check
 */
export function EmptyWalletShimmer() {
  return (
    <Fill backgroundColor="Bg Color" justifyContent="center" alignItems="center" px={20}>
      <Column alignItems="center" gap={24}>
        <ShimmerBox width={175} height={200} borderRadius={16} />
        <Column alignItems="center" gap={8}>
          <ShimmerBox width={200} height={28} borderRadius={6} />
          <ShimmerBox width={250} height={20} borderRadius={4} />
        </Column>
        <ShimmerBox width={280} height={52} borderRadius={26} />
      </Column>
    </Fill>
  );
}
